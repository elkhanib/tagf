...
// SearchCmd bla bla
type AllFilesCmd struct {
}

// SearchAPI  bla bla
type AllFilesAPI struct {
	AllFilesCmd
}

func allFiles(s *AllFilesCmd) ([]string, error) {
...
// Run bla bla
func (s AllFilesAPI) Run() ([]string, error) {
	return allFiles(&s.AllFilesCmd)
}

// Run bla bla
func (s AllFilesCmd) Run() error {
	files, err := allFiles(&s)
